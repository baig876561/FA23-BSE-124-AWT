        ...
        <div className='min-h-[80vh] flex items-center justify-center px-4 py-12'>
            <div className='w-full max-w-md animate-slide-up'>
                <div className='text-center mb-8'>
                    ...
                    <p className='text-slate-500 text-sm mt-2'>Join Doctor Hub — healthcare made simple</p>
                </div>
                ...
                <form onSubmit={onSubmit} className='card p-8 space-y-5'>
                    ...
                    <div>
                        <label className='text-sm font-medium text-slate-700 mb-1.5 block'>Register as</label>
                ...
                <p className='text-center text-sm text-slate-500 mt-6'>
                    ...
                    <Link to='/login/patient' className='text-brand-600 font-semibold hover:text-brand-700'>Sign in</Link>
                </p>
            </div>
        </div>
    )
